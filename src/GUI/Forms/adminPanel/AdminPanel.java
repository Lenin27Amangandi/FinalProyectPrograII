...
import GUI.Forms.pinturaPanel.PinturaPanel;
import GUI.Forms.usuarioPanel.UsuarioPanel;
...
public class AdminPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Image img = cargarImagen("/utils/logos/InicioAdmin.png");
        if (img != null) {
    ...
    public void mostrarInicio() {
        JPanel inicioPanel = new JPanel() {
            private final Image img = cargarImagen("/utils/logos/InicioAdmin.png");
    ...
    private Image cargarImagen(String ruta) {
        try {
            ...
            RAConfig.showMsgError("Error al cargar la Imagen");
            return null;
        }
    }
