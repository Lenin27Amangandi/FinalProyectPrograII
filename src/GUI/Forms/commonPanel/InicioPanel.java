...
import GUI.Estilo.*;
import GUI.Forms.adminPanel.IngresoAdminPanel;
...
public class InicioPanel extends JPanel {
    ...
    public InicioPanel(JFrame parentFrame) {
        ...
        BackgroundPanel backgroundPanel = new BackgroundPanel("src/utils/logos/InicioImage.png");
    ...
    private JPanel createSidebar() {
        ...
        JButton visitarButton = ComponentFactory.crearBotonSidebar("Visitar Museo", e -> {
            try {
                ...
                RAConfig.showMsgError("Error al ir como visitante");
            }
        });
